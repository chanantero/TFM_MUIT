function [expAcPath, freq, yPulseCoefMat] = getAcousticPath( xPulseLimits, freq, xPulseCoefMat, y, ySampleRate)
...
for f = 1:numFrequencies
    expAcPath(:, :, f) = (xPulseCoefMat_uniqueFreq(:, :, f)\yPulseCoefMat(:, :, f)).';
end
