...
%% Scenario asked by the teacher
% They want to know if the correction factor when there is frecuency
% correction is 1. It should be
...
% printfig(ax1.Parent, imagesPath, 'Experiment7_corrFactIndCancAbs_FC', 'eps');
...
% printfig(ax2.Parent, imagesPath, 'Experiment7_corrFactIndCancPhase_FC', 'eps');
...
% printfig(ax3.Parent, imagesPath, 'Experiment7_corrFactGlobCancAbs_FC', 'eps');
...
% printfig(ax4.Parent, imagesPath, 'Experiment7_corrFactGlobCancPhase_FC', 'eps');
